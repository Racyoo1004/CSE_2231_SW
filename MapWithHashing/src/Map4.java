...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    private void createNewRep(int hashTableSize) {
        ...
        for (int c = 0; c < hashTableSize; c++) {
            Map<K, V> map = new Map2<>();
            this.hashTable[c] = map;
        }
    }
    ...
    public final void add(K key, V value) {
        ...
        this.hashTable[hash].add(key, value);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        return this.hashTable[hash].remove(key);
    }
    ...
    public final Pair<K, V> removeAny() {
        ...
        while (i < this.hashTable.length && !notEmpty) {
    ...
    public final V value(K key) {
        ...
        return this.hashTable[hash].value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        int hash = mod(key.hashCode(), this.hashTable.length);
        found = this.hashTable[hash].hasKey(key);
